 ...
 *
 * Two normalizations, both of them things the OS does and the glob does not:
 *
 ...
 *
 * Matched twice: once as written, once normalized. Both are needed, and for
 * different reasons. The normalized pass is what closes the case and
 ...
 * intended direction to be wrong in, and it is the reason this normalizes the
